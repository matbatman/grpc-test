...
const (
	...
	PingService_PingReverse_FullMethodName = "/ping.PingService/PingReverse"
)
...
type PingServiceClient interface {
	...
	PingReverse(ctx context.Context, in *PingRequest, opts ...grpc.CallOption) (*PingResponse, error)
}
...
func (c *pingServiceClient) PingReverse(ctx context.Context, in *PingRequest, opts ...grpc.CallOption) (*PingResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PingResponse)
	err := c.cc.Invoke(ctx, PingService_PingReverse_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PingServiceServer interface {
	...
	PingReverse(context.Context, *PingRequest) (*PingResponse, error)
...
func (UnimplementedPingServiceServer) PingReverse(context.Context, *PingRequest) (*PingResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method PingReverse not implemented")
}
...
func _PingService_PingReverse_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PingRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PingServiceServer).PingReverse(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PingService_PingReverse_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PingServiceServer).PingReverse(ctx, req.(*PingRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var PingService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "PingReverse",
			Handler:    _PingService_PingReverse_Handler,
		},
	},
